...
if __name__ == "__main__":
    data_name = "Text2image"
    output_folder = "/root/hdd-data/Text2image/Index_Learning_code"

    Text2image_base_path = "/root/hdd-data/Text2image/learn/base_data_1M.txt"
    Text2image_query_path = "/root/hdd-data/Text2image/learn/query_data_100.txt"
    Text2image_groundtruth_path = "/root/hdd-data/Text2image/learn/groundtruth_id_100.txt"

    Text2image_train_data = "/root/hdd-data/Text2image/learn/train_data_1.5M.txt"
    Text2image_train_query = "/root/hdd-data/Text2image/learn/train_query_700K.txt"
    ...
    train_data = np.loadtxt(Text2image_train_data)
    # random_indices = torch.randperm(train_data.shape[0])
    # train_data = train_data[random_indices[:100000]]
    train_query = np.loadtxt(Text2image_train_query)
    test_data = np.loadtxt(Text2image_base_path)
    test_query = np.loadtxt(Text2image_query_path)
    test_gt = np.loadtxt(Text2image_groundtruth_path)
    ...
    kmeans_file = "/root/hdd-data/Text2image/learn/base_kmeans.txt"
