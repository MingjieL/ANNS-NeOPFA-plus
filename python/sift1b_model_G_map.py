...
net_i = 10
net_file = f"/root/hdd-data/sift1b/step02/models/sift1b_h{net_i}_model.NN"
time_file = f"/root/hdd-data/sift1b/step02/models/sift1b_h{net_i}_model_time.txt"

for knn in range(10, 101, 10):
    sift1b_test_file = f"/root/hdd-data/sift1b/step02/method_T10/sift1b_k{knn}.txt"
    sift1b_label_file = f"/root/hdd-data/sift1b/step02/method_T10/sift1b_label_h{net_i}_k{knn}.txt"

    test_features = np.loadtxt(sift1b_test_file)
    ...
    np.savetxt(sift1b_label_file, data_output, fmt='%.6f')
