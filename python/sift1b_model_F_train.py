...
sift1b_query_train_file = "/root/hdd-data/sift1b/cluster/train/train_query_100K.txt"
sift1b_query_test_file = "/root/hdd-data/sift1b/cluster/test/query_test.txt"

sift1b_cluster_train_file = "/root/hdd-data/sift1b/cluster/train/new_cluster_k100.txt"
sift1b_cluster_test_file = "/root/hdd-data/sift1b/cluster/test/cluster_k100.txt"

net_folder = "/root/hdd-data/sift1b/cluster/models"

train_features = np.loadtxt(sift1b_query_train_file)
train_features = torch.from_numpy(train_features).float()

train_labels = np.loadtxt(sift1b_cluster_train_file)
train_labels = torch.from_numpy(train_labels).float()

test_features = np.loadtxt(sift1b_query_test_file)
test_features = torch.from_numpy(test_features).float()
test_labels = np.loadtxt(sift1b_cluster_test_file)
...
model = SimpleNet(input_size=128)
