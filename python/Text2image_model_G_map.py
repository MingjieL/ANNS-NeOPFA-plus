...
net_i = 10
net_file = f"/root/hdd-data/Text2image/step02/models/Text2image_h{net_i}_model.NN"
time_file = f"/root/hdd-data/Text2image/step02/models/Text2image_h{net_i}_model_time.txt"

for knn in range(10, 101, 10):
    Text2image_test_file = f"/root/hdd-data/Text2image/step02/method_T10/Text2image_k{knn}.txt"
    Text2image_label_file = f"/root/hdd-data/Text2image/step02/method_T10/Text2image_label_h{net_i}_k{knn}.txt"

    test_features = np.loadtxt(Text2image_test_file)
    ...
    np.savetxt(Text2image_label_file, data_output, fmt='%.6f')
