...
sift1b_train_file = "/root/hdd-data/sift1b/step02/train/sift1b_train_10M.txt"
sift1b_label_file = "/root/hdd-data/sift1b/step02/train/sift1b_label_10M.txt"
net_file = "/root/hdd-data/sift1b/step02/models/sift1b_h10_model.NN"

train_features = np.loadtxt(sift1b_train_file)
train_features = torch.from_numpy(train_features).float()

train_labels = np.loadtxt(sift1b_label_file)
