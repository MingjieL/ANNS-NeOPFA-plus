...
deep1b_train_file = "/root/hdd-data/deep1b/step02/train/deep1b_train_10M.txt"
deep1b_label_file = "/root/hdd-data/deep1b/step02/train/deep1b_label_10M.txt"
net_file = "/root/hdd-data/deep1b/step02/models/deep1b_h10_model.NN"

train_features = np.loadtxt(deep1b_train_file)
train_features = torch.from_numpy(train_features).float()

train_labels = np.loadtxt(deep1b_label_file)
