...
deep1b_query_train_file = "/root/hdd-data/deep1b/cluster/train/train_query_100K.txt"
deep1b_query_test_file = "/root/hdd-data/deep1b/cluster/test/query_test.txt"

deep1b_cluster_train_file = "/root/hdd-data/deep1b/cluster/train/new_cluster_k100.txt"
deep1b_cluster_test_file = "/root/hdd-data/deep1b/cluster/test/cluster_k100.txt"

net_folder = "/root/hdd-data/deep1b/cluster/models"

train_features = np.loadtxt(deep1b_query_train_file)
train_features = torch.from_numpy(train_features).float()
train_labels = np.loadtxt(deep1b_cluster_train_file)
train_labels = torch.from_numpy(train_labels).float()


test_features = np.loadtxt(deep1b_query_test_file)
test_features = torch.from_numpy(test_features).float()
test_labels = np.loadtxt(deep1b_cluster_test_file)
