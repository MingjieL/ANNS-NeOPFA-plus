...
if __name__ == "__main__":
    ...
    n_hidden = 512
    n_output = 20
    data_file = "/root/hdd-data/deep1b/data.ds"
    query_file = "/root/hdd-data/deep1b/query.txt"
    net_folder = "/root/hdd-data/deep1b/Index_Learning_code/models_deep1b_d{}_v{}_{}".format(n_output, v, v_v)
    n_num = 1000000000
    q_num = 100
    sub_num = 100000
    n_dimensions = 96
    ...
    # model_file = net_folder + "/deep1b_last_iteration.NN"
    model_file = net_folder + "/deep1b_{}.NN".format(net_i)
