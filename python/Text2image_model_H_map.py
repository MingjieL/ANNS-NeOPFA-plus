...
if __name__ == "__main__":
    ...
    n_hidden = 512
    n_output = 25
    data_file = "/root/hdd-data/Text2image/data.ds"
    query_file = "/root/hdd-data/Text2image/query.txt"
    net_folder = "/root/hdd-data/Text2image/Index_Learning_code/models_Text2image_d{}_v{}_{}".format(n_output, v, v_v)
    n_num = 999999900
    q_num = 100
    sub_num = 215100
    n_dimensions = 200
    ...
    # model_file = net_folder + "/Text2image_last_iteration.NN"
    model_file = net_folder + "/Text2image_{}.NN".format(net_i)
