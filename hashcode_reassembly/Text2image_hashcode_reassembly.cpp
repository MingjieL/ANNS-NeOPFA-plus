...
unsigned long int n_num = 999999900;
...
int main() {
    ...
    char *new_pro_file = "/root/hdd-data/Text2image/pro_kmeans_data/Text2image_new_base_d25_v10_vv38_9.bin";
    char *K1_num_file = "/root/hdd-data/Text2image/pro_kmeans_data/kmeans_num_K1.txt";
    char *K2_num_file = "/root/hdd-data/Text2image/pro_kmeans_data/kmeans_num_K2.txt";
    char *ori_map_new_file = "/root/hdd-data/Text2image/pro_kmeans_data/ori_map_new.ds";
    char *new_map_ori_file = "/root/hdd-data/Text2image/pro_kmeans_data/new_map_ori.ds";
    ...
    for (int k = 0; k < K1; k++) {
        ...
        sprintf(base_file, "/root/hdd-data/Text2image/pro_kmeans_data/data_%d", k);
        sprintf(map_file, "/root/hdd-data/Text2image/pro_kmeans_data/map_%d.txt", k);
        sprintf(kmeans_file, "/root/hdd-data/Text2image/pro_kmeans_data/kmeans_%d.txt", k);
