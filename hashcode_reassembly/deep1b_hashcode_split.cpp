...
void openFile(FILE** file, ofstream *ofs) {
    for (int i = 0; i < K1; i++) {
        char base_file[256];
        char map_file[256];
        sprintf(base_file, "/root/hdd-data/deep1b/pro_kmeans_data/data_%d", i);
        sprintf(map_file, "/root/hdd-data/deep1b/pro_kmeans_data/map_%d.txt", i);
...
int main() {
    char *base_file = "/root/hdd_data/deep1b/data.ds";
    char *pro_base_file = "/root/hdd-data/deep1b/Index_Learning_code/models_deep1b_d25_v10_38/deep1b_base_d25_v10_vv38_9.bin";
    char *kmeans_file = "/root/hdd-data/deep1b/forest_64_256_8/codes1.txt";
    char *kmeans_num_file = "/root/hdd-data/deep1b/pro_kmeans_data/kmeans_num_K1.txt";
